...
class ConvPred(ESModule):
    ...
    def __init__(self, input_dim=188, hidden_dim=64, output_dim=1, conv_channels=32, 
                in_cont_channels=13, kernel_size=3, pred_dim=18):
...
class ConvPredCat(ESModule):

    def __init__(self, input_dim=178, hidden_dim=64, output_dim=1, conv_channels=32, 
                in_cont_channels=13, in_cat_dim=44, kernel_size=3, pred_dim=18):
        super(ConvPredCat, self).__init__()
        self.hidden_dim = hidden_dim
        self.input_dim = input_dim
        self.conv_chanels = conv_channels
        self.output_dim = output_dim
